...
* The Docker Compose files `docker-compose-prod-mysql.yml` and `docker-compose-prod-postgres.yml` in the folder `docker-compose` of the GitHub repository always use the most recent released version of SecObserve.
