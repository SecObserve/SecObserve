...
* [`docker-compose-dev.yml`](https://github.com/SecObserve/SecObserve/blob/dev/docker-compose/docker-compose-dev.yml)
...
* [`docker-compose-dev-multi.yml`](https://github.com/SecObserve/SecObserve/blob/dev/docker-compose/docker-compose-dev-multi.yml)
...
* [`docker-compose-dev-mysql.yml`](https://github.com/SecObserve/SecObserve/blob/dev/docker-compose/docker-compose-dev-mysql.yml)
    - Starts the MySQL database, as well as SecObserve's backend and frontend
    - Backend and frontend are build automatically if necessary and are started in development mode with hot reloading
* [`docker-compose-dev-keycloak.yml`](https://github.com/SecObserve/SecObserve/blob/dev/docker-compose/docker-compose-dev-keycloak.yml)
...
* [`docker-compose-dev-arm.yaml`](https://github.com/SecObserve/SecObserve/blob/dev/docker-compose/docker-compose-dev-arm.yaml)
    ...
    - Start it together with the standard development file:
      ...
      ```
* [`docker-compose-playwright.yml`](https://github.com/SecObserve/SecObserve/blob/dev/docker-compose/docker-compose-playwright.yml)
    - Starts the end-to-end tests with Playwright
* [`docker-compose-prod-test.yml`](https://github.com/SecObserve/SecObserve/blob/dev/docker-compose/docker-compose-prod-test.yml)
    - Starts the PostgreSQL database, as well as SecObserve's backend and frontend
...
* [`docker-compose-prod-test-multi.yml`](https://github.com/SecObserve/SecObserve/blob/dev/docker-compose/docker-compose-prod-test-multi.yml)
...
* [`docker-compose-unittests.yml`](https://github.com/SecObserve/SecObserve/blob/dev/docker-compose/docker-compose-unittests.yml)
...
* [`docker-compose.yml`](https://github.com/SecObserve/SecObserve/blob/dev/docker-compose/docker-compose.yml)
    - This is a link to `docker-compose-dev.yml` and is used as a default for the `docker compose` command, when it is run in the folder `docker-compose`

## Production

See the [installation](../getting_started/installation.md) guide how to use the productive Docker Compose files.

* [`docker-compose-prod-postgres.yml`](https://github.com/SecObserve/SecObserve/blob/main/docker-compose/docker-compose-prod-postgres.yml)
* [`docker-compose-prod-mysql.yml`](https://github.com/SecObserve/SecObserve/blob/main/docker-compose/docker-compose-prod-mysql.yml)
