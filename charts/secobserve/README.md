...
![Version: 1.0.9](https://img.shields.io/badge/Version-1.0.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.44.0](https://img.shields.io/badge/AppVersion-1.44.0-informational?style=flat-square)
...
| backend.image.tag | string | `"1.44.0"` |  |
...
| frontend.image.tag | string | `"1.44.0"` |  |
