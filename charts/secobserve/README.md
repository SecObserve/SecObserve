...
![Version: 1.0.10](https://img.shields.io/badge/Version-1.0.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.44.1](https://img.shields.io/badge/AppVersion-1.44.1-informational?style=flat-square)
...
| backend.image.tag | string | `"1.44.1"` |  |
...
| frontend.image.tag | string | `"1.44.1"` |  |
