...
export const PURL_TYPE_CHOICES = [
    ...
    { id: "bazel", name: "Bazel (bazel)" },
    { id: "otp", name: "BEAM/OTP (otp)" },
    { id: "bitbucket", name: "Bitbucket (bitbucket)" },
    { id: "bitnami", name: "Bitnami (bitnami)" },
    { id: "brew", name: "Brew (brew)" },
    { id: "vcpkg", name: "C/C++ (vcpkg)" },
    { id: "chrome-extension", name: "Chrome (chrome-extension)" },
    { id: "cocoapods", name: "Cocoapods (cocoapods)" },
    { id: "composer", name: "Composer (composer)" },
    { id: "conan", name: "Conan (conan)" },
    { id: "conda", name: "Conda (conda)" },
    { id: "cpan", name: "CPAN Perl (cpan)" },
    { id: "cran", name: "CRAN R (cran)" },
    { id: "pub", name: "Dart (pub)" },
    { id: "deb", name: "Debian (deb)" },
    { id: "docker", name: "Docker (docker)" },
    { id: "generic", name: "Generic (generic)" },
    { id: "git", name: "Git (git)" },
    { id: "github", name: "GitHub (github)" },
    { id: "golang", name: "Go (golang)" },
    { id: "hackage", name: "Hackage (hackage)" },
    { id: "hex", name: "Hex (hex)" },
    { id: "huggingface", name: "Huggingface (huggingface)" },
    { id: "julia", name: "Julia (julia)" },
    { id: "luarocks", name: "Lua (luarocks)" },
    { id: "maven", name: "Maven (maven)" },
    { id: "mlflow", name: "MLflow (mlflow)" },
    { id: "npm", name: "NPM (npm)" },
    { id: "nuget", name: "NuGet (nuget)" },
    { id: "opam", name: "OCaml (opam)" },
    { id: "oci", name: "OCI (oci)" },
    { id: "pypi", name: "PyPI (pypi)" },
    { id: "qpkg", name: "QNX (qpkg)" },
    { id: "rpm", name: "Red Hat (rpm)" },
    { id: "gem", name: "Ruby Gem (gem)" },
    { id: "cargo", name: "Rust (cargo)" },
    { id: "swid", name: "SWID (swid)" },
    { id: "swift", name: "Swift (swift)" },
    { id: "vscode-extension", name: "Visual Studio Code (vscode-extension)" },
    { id: "yocto", name: "Yocto (yocto)" },
];
